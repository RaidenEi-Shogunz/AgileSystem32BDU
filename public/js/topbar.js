document.addEventListener("DOMContentLoaded", () => {
    ...
    <div class="topbar" style="position: relative;">
      ...
      <div class="search-bar" style="position: relative;">
        ...
        <ul id="search-suggestions" style="
          ...
          border:1px solid #ccc; display:none; z-index:99999;
      ...
      <div class="topbar-right" style="display:flex; align-items:center; gap:2vw;">
        <span>
          <a href="cart.html" style="font-size: 1.5vw; display:flex; align-items:center; gap:0.5vw;">
  ...
  // 3) Hiển thị avatar nếu login
  const userInfoSpan = document.getElementById("user-info");
  const loggedInUser = JSON.parse(localStorage.getItem("loggedInUser") || "null");
  if (loggedInUser && localStorage.getItem("loginStatus") === "logged_in") {
    userInfoSpan.innerHTML = `
      <a href="profile.html" style="display:inline-flex; align-items:center; gap:5px;">
        <img src="/images/news/news.jpg" alt="User Icon"
          style="width:4vw; height:4vw; border-radius:50%; object-fit:cover;">
      </a>
    `;
  }
